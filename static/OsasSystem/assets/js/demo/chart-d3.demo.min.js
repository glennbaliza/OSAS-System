...
handleBarChart=function(){
    ...
    nv.addGraph(function(){
        ...
        handlePieAndDonutChart=function(){
            "use strict";
            var e=[
                {label:"Complete",value:document.getElementById("lost_id_completed").value,color:COLOR_RED},
                {label:"On Process",value:document.getElementById("lost_id_process").value,color:COLOR_ORANGE},
                {label:"Pending",value:document.getElementById("lost_id_pending").value,color:COLOR_GREEN},
            ];
