# Generated by Django 3.0 on 2021-07-29 03:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0057_auto_20210727_0923'),
    ]

    operations = [
        migrations.AddField(
            model_name='org_accreditation',
            name='acc_datesubmitted',
            field=models.DateField(null=True),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='date_created',
            field=models.DateField(default=datetime.datetime(2021, 7, 29, 3, 7, 29, 521191, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
