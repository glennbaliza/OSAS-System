# Generated by Django 3.0 on 2021-07-11 02:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0044_auto_20210705_1447'),
    ]

    operations = [
        migrations.AddField(
            model_name='organization',
            name='org_accre_status',
            field=models.IntegerField(default=0),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='date_created',
            field=models.DateField(default=datetime.datetime(2021, 7, 11, 2, 45, 58, 308008, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
