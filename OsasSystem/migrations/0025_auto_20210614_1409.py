# Generated by Django 3.0 on 2021-06-14 06:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0024_auto_20210614_1247'),
    ]

    operations = [
        migrations.AddField(
            model_name='fund_file',
            name='fund_fund_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='OsasSystem.fund'),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 14, 6, 9, 19, 100464, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 14, 6, 9, 19, 100464, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 14, 6, 9, 19, 100464, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 14, 6, 9, 19, 100464, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 6, 14, 6, 9, 19, 100464, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
