# Generated by Django 3.0 on 2021-06-29 08:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0038_auto_20210628_1231'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            name='osas_t_id_file',
            fields=[
                ('id_file_id', models.AutoField(primary_key=True, serialize=False)),
                ('id_file', models.FileField(upload_to='')),
                ('id_file_ext', models.CharField(max_length=20)),
                ('id_datecreated', models.DateField(default=datetime.datetime(2021, 6, 29, 8, 49, 2, 718587, tzinfo=utc))),
                ('id_lost_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OsasSystem.osas_t_id')),
            ],
        ),
    ]
