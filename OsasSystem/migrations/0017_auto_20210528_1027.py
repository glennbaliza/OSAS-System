# Generated by Django 3.0 on 2021-05-28 02:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0016_auto_20210519_1216'),
    ]

    operations = [
        migrations.AddField(
            model_name='concept_paper_title',
            name='title_dateapproved',
            field=models.DateField(null=True),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 5, 28, 2, 27, 29, 928941, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 28, 2, 27, 29, 928941, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 28, 2, 27, 29, 928941, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 5, 28, 2, 27, 29, 928941, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 5, 28, 2, 27, 29, 928941, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
