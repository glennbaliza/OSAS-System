# Generated by Django 3.0 on 2021-04-21 01:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0015_auto_20210419_1406'),
    ]

    operations = [
        migrations.AddField(
            model_name='org_accreditation',
            name='acc_return_file',
            field=models.FileField(blank=True, null=True, upload_to=OsasSystem.models.return_file_path),
        ),
        migrations.AlterField(
            model_name='org_accreditation',
            name='acc_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 4, 21, 1, 31, 42, 174474, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='org_accreditation',
        ...
        migrations.AlterField(
            ...
            name='ct_datecreated',
            field=models.DateTimeField(default=datetime.datetime(2021, 4, 21, 1, 31, 42, 174474, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
            name='course_add_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 4, 21, 1, 31, 42, 174474, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 4, 21, 1, 31, 42, 174474, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 4, 21, 1, 31, 42, 174474, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
