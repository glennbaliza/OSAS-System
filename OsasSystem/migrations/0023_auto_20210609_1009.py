# Generated by Django 3.0 on 2021-06-09 02:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0022_auto_20210602_1218'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='officer',
            name='off_signature_ext',
            field=models.CharField(max_length=20, null=True),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 9, 2, 9, 38, 519399, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 9, 2, 9, 38, 519399, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 9, 2, 9, 38, 519399, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 9, 2, 9, 38, 519399, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 6, 9, 2, 9, 38, 519399, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
