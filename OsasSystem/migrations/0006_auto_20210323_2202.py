# Generated by Django 3.0 on 2021-03-23 14:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0005_auto_20210306_2354'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_datecreated', models.DateField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc))),
                ('org_dateupdated', models.DateField(null=True)),
            ],
        ),
        migrations.AlterField(
            model_name='osas_notif',
            name='notif_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='ct_datecreated',
            field=models.DateTimeField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
            name='course_add_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 3, 23, 14, 2, 55, 288797, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
