# Generated by Django 3.0 on 2021-02-03 10:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_updated', models.DateTimeField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ct_datecreated', models.DateTimeField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='osas_r_course',
            fields=[
                ...
                ('course_edit_date', models.DateField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation_datecreated', models.DateTimeField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stud_birthdate', models.DateField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc), max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yas_dateregistered', models.DateTimeField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excuse_datecreated', models.DateTimeField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
                ('excuse_dateupdated', models.DateField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='osas_t_id',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sanction_dateupdated', models.DateField(default=datetime.datetime(2021, 2, 3, 10, 15, 22, 110343, tzinfo=utc))),
        ...
        migrations.AddField(
            ...
            name='excuse_sanction_id',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='OsasSystem.osas_t_sanction'),
        ),
        migrations.AddField(
            model_name='osas_t_excuse',
            name='excuse_stud_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OsasSystem.osas_r_personal_info'),
        ),
        migrations.AddField(
