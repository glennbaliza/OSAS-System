# Generated by Django 3.0 on 2021-05-05 04:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0027_auto_20210505_0938'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2021, 5, 5, 4, 54, 52, 328229, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='org_accreditation',
        ...
        migrations.AlterField(
            model_name='organization',
            name='org_status',
            field=models.CharField(default='ACCREDITED', max_length=10),
        ),
        migrations.AlterField(
            model_name='organization_chat',
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 5, 4, 54, 52, 328229, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 5, 4, 54, 52, 328229, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 5, 5, 4, 54, 52, 328229, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 5, 5, 4, 54, 52, 328229, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
