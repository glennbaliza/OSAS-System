# Generated by Django 3.0 on 2021-04-14 01:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0011_auto_20210330_2218'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateField(default=datetime.datetime(2021, 4, 14, 1, 42, 53, 254133, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='org_accreditation',
        ...
        migrations.AlterField(
            model_name='org_accreditation',
            name='acc_file',
            field=models.FileField(blank=True, null=True, upload_to=OsasSystem.models.file_path),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='ct_datecreated',
            field=models.DateTimeField(default=datetime.datetime(2021, 4, 14, 1, 42, 53, 254133, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
            name='course_add_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 4, 14, 1, 42, 53, 254133, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 4, 14, 1, 42, 53, 254133, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 4, 14, 1, 42, 53, 254133, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
