# Generated by Django 3.0 on 2021-06-28 04:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('OsasSystem', '0034_auto_20210628_1131'),
    ]

    operations = [
        migrations.AddField(
            model_name='concept_paper_title',
            name='title_accomplishment_file',
            field=models.FileField(blank=True, null=True, upload_to=''),
        ),
        migrations.AlterField(
            model_name='classroom',
            name='room_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 28, 4, 20, 10, 143593, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='classroom',
        ...
        migrations.AlterField(
            ...
            name='msg_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 28, 4, 20, 10, 143593, tzinfo=utc)),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 6, 28, 4, 20, 10, 143593, tzinfo=utc), max_length=50),
        ),
        migrations.AlterField(
            model_name='osas_r_course',
        ...
        migrations.AlterField(
            ...
            name='ds_datecreated',
            field=models.DateField(default=datetime.datetime(2021, 6, 28, 4, 20, 10, 143593, tzinfo=utc), null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='osas_r_personal_info',
            name='stud_birthdate',
            field=models.DateField(default=datetime.datetime(2021, 6, 28, 4, 20, 10, 143593, tzinfo=utc), max_length=12),
        ),
        migrations.AlterField(
